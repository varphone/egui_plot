...
impl ChartsDemo {
    ...
    fn pies(&self, ui: &mut egui::Ui) -> Response {
        ...
        let pie_chart1 = PieChart::new("pie_chart1", [-6.0, 0.0], 5.0, data.clone())
            .name("TIOBE - April 2024")
            .labels(labels.clone());
        let pie_chart2 = PieChart::new("pie_chart1", [6.0, 0.0], 5.0, data).labels(labels);
